...
namespace ReportingREC.Models
{
    class Helper
    {
        ...
        public static async Task EnviarConfirmacion(string Cuerpo)
        {
            var Mensaje = new MailMessage();
            //Mensaje.To.Add(new MailAddress(""));
            Mensaje.To.Add(new MailAddress("losorio@conhydra.com"));
        ...
        public static async Task EnviarConfirmacion(string Cuerpo, string Correo, string copiami)
        {
            var Mensaje = new MailMessage();

            Mensaje.To.Add(new MailAddress(Correo));

            if (string.Equals("Si", copiami))
            {
            ...
            Mensaje.Subject = "Reporte Personal Conhydra SAS ESP";
